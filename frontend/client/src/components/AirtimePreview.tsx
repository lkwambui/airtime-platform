  ...
  return (
    <div className="relative group">
      ...
      <div
        className={`relative ${
          theme === "dark"
            ? "bg-linear-to-br from-slate-700 to-slate-800 border-slate-600/50"
            : "bg-linear-to-br from-gray-100 to-gray-50 border-gray-200/50"
        } border rounded-2xl p-6 text-center space-y-2`}
      >
        <p
